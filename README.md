...
## 3. Full code
Full code is available [here](source/agent_pdf.py) for the first agent and [here](source/agent_images.py) for the second. Beware, to modify the path to PDF forlder accordingly. When you drop the PDF into folder agent will process this file or files the way as described above.
